...
- 双击Shift / Ctrl + Shift + F 全局查找
- Ctrl + F12 查看光标所在类的所有成员(方法+属性)
- Ctrl + H 查看光标所在类的继承树
- Ctrl + Shift + 上下键 上下移动方法
- Alt + Shift + 上下键  上下移动代码行
- Shift + F6 包/类重命名
- Ctrl + Shift + Enter 自动结束代码
- Ctrl + E 查看最近文件 
- Ctrl + Shift + E 查看最近编辑过的文件
- Alt + F7 查看当前变量所有被使用的位置
- Ctrl + Alt + B 跳转到光标所在接口方法的具体实现位置
- Ctrl + O 查看当前类可以重写的方法
- Ctrl + P 提示当前方法的参数(重载方法会有多列)
...
```
Ctrl + Shift + 左右键 配合Alt+1,跳转到project侧边栏视图时, 调整侧边栏宽度
Ctrl + Shift + 上下键    光标放在方法名上，将方法移动到上一个方法前面，调整方法排序 （必备）
```
